export const ROYALTY_TOKEN_ADDRESS =
  "0x991C4873cCc7ebA75E09fF2a94D5e60331C86a3e";
...
export const ROYALTY_TOKEN_ABI = [
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint48", name: "key", type: "uint48" },
    ],
    name: "Checkpoint",
    type: "event",
  },
  ...
  },
  {
    ...
    name: "checkpoint",
    outputs: [
      { internalType: "uint48", name: "newCheckpointKey", type: "uint48" },
    ],
    stateMutability: "nonpayable",
    type: "function",
  },
