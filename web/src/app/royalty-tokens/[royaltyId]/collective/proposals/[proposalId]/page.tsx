          ...
          <div className="rounded-xl border p-6 shadow">
            ...
            <div className="grid gap-2">
              <div className="rounded-xl border bg-card p-4 text-card-foreground shadow">
                ...
                <div className="text-xl font-semibold">{proposal.votes.for}</div>
              </div>
              <div className="rounded-xl border bg-card p-4 text-card-foreground shadow">
                <div className="flex items-center justify-between pb-2">
                ...
                <div className="text-xl font-semibold">{proposal.votes.against}</div>
              </div>
              <div className="rounded-xl border bg-card p-4 text-card-foreground shadow">
                <div className="flex items-center justify-between pb-2">
                ...
                <div className="text-xl font-semibold">{proposal.votes.abstain}</div>
              </div>
            </div>
