export const ROYALTY_TOKEN_ADDRESS = '0x8FC2093799C2952a73B6671BD199344ec5d41498' as `0x${string}`;
export const ROYALTY_PAYMENT_POOL_ADDRESS = '0xFC33EAF7cBd9E0d71561dcaBa57Ce1Db45515B63' as `0x${string}`;
export const STABLECOIN_ADDRESS = '0x5709c84F4751b259DF9CEE64a7528A7D3afFcFF2' as `0x${string}`;
export const OTC_MARKET_ADDRESS = '0x125e1A89941d642BfD15735B6F5FeA5cDe3AC26C' as `0x${string}`;
export const STAKEHOLDER_ADDRESS = '0xf56f09DbE51FF4b1f446132e4E3d9E337B1dF3Ea' as `0x${string}`;
export const ROYALTY_EXCHANGE_ADDRESS = '0x56073492715aD97209dA61BC1916CcFC563a728E' as `0x${string}`;
export const INITIAL_ROYALTY_OFFERING_ADDRESS = '0xc1d69051E60a9515b589ed2D05728dE9840F2892' as `0x${string}`;

export const ROYALTY_TOKEN_ABI = [
  {
  ...
  { inputs: [], name: 'InvalidCheckpoint', type: 'error' },
  { inputs: [], name: 'InvalidShortString', type: 'error' },
  {
    inputs: [
      { internalType: 'uint48', name: 'checkpointKey', type: 'uint48' },
      { internalType: 'uint48', name: 'currentCheckpointKey', type: 'uint48' },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint48', name: 'key', type: 'uint48' }],
    name: 'Checkpoint',
    type: 'event',
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'checkpoint',
    outputs: [{ internalType: 'uint48', name: 'newCheckpointKey', type: 'uint48' }],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
  ...
  {
    inputs: [{ internalType: 'uint48', name: 'checkpointKey', type: 'uint48' }],
    name: 'totalSupplyAt',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
...
export const ROYALTY_PAYMENT_POOL_ABI = [
  ...
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'from', type: 'address' },
      { indexed: true, internalType: 'uint256', name: 'deposit', type: 'uint256' },
...
export const STAKEHOLDER_COLLECTIVE_ABI = [
  {
    inputs: [
      { internalType: 'contract IVotes', name: 'royaltyToken', type: 'address' },
      { internalType: 'string', name: 'name', type: 'string' },
    ],
    stateMutability: 'nonpayable',
    type: 'constructor',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'enum IGovernor.ProposalState', name: 'current', type: 'uint8' },
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, internalType: 'uint256', name: 'proposalId', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'etaSeconds', type: 'uint256' },
    ],
    name: 'ProposalQueued',
    type: 'event',
  },
  ...
  {
    inputs: [{ internalType: 'uint48', name: 'newVotingDelay', type: 'uint48' }],
    name: 'setVotingDelay',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    inputs: [{ internalType: 'uint32', name: 'newVotingPeriod', type: 'uint32' }],
...
export const INITIAL_ROYALTY_OFFERING_ABI = [
  {
    inputs: [
      { internalType: 'address', name: 'initialOwner', type: 'address' },
      { internalType: 'contract IERC20', name: 'royaltyToken', type: 'address' },
